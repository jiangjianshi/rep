...
$(document).ready(function() {
	grid = $("#dataGrid").datagrid({
		title : '',
		url : basePath + '/commonCtrl/loadByPage.c?t=sjdw_unit-sql&s=searchList',
		...
		onDblClickRow: function(rowIndex, rowData){
			var url = basePath+"/oa/baseinfor/editSjdwUnit.c?id="+rowData.pkId;
...
//添加-窗口
function add() {
	var url = basePath+"/oa/baseinfor/addSjdwUnit.c";
...
function edit() {
	...
	var url = basePath+"/oa/baseinfor/editSjdwUnit.c?id="+selectRow.pkId;
	openDialog(500,500,"编辑",url);
}
//删除
function del() {
	...
	var url = basePath + "/oa/baseinfor/delSjdwUnits.c?delIds="+selectRows_arr;
