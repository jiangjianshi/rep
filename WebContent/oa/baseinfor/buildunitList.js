...
$(document).ready(function() {
	grid = $("#dataGrid").datagrid({
		...
		onDblClickRow: function(rowIndex, rowData){
			var url = basePath+"/oa/baseinfor/editBuildUnit.c?id="+rowData.pkId;
...
//添加-窗口
function add() {
	var url = basePath+"/oa/baseinfor/addBuildUnit.c";
...
function edit() {
	...
	var url = basePath+"/oa/baseinfor/editBuildUnit.c?id="+selectRow.pkId;
	openDialog(500,300,"编辑",url);
}
//删除
function del() {
	...
	var url = basePath + "/oa/baseinfor/delBuildUnits.c?delIds="+selectRows_arr;
