...
$(document).ready(function() {
	grid = $("#dataGrid").datagrid({
		...
		onDblClickRow: function(rowIndex, rowData){
			var url = basePath+"/oa/baseinfor/editKcdwUnit.c?id="+rowData.pkId;
...
//添加-窗口
function add() {
	var url = basePath+"/oa/baseinfor/addKcdwUnit.c";
...
function edit() {
	...
	var url = basePath+"/oa/baseinfor/editKcdwUnit.c?id="+selectRow.pkId;
	openDialog(500,500,"编辑",url);
}
//删除
function del() {
	...
	var url = basePath + "/oa/baseinfor/delKcdwUnits.c?delIds="+selectRows_arr;
