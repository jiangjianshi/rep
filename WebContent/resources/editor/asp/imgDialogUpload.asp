...
If oUpload.Err > 0 Then
	...
	response.Write("<script language=javascript>top.Dialog.alert('上传成功!',function(){ownerDialog.close();});top.mainFrame().editor.insertHtml('<img src=\'"&websiteurl&"/uploadfile/"&sSaveFileName&"\' />');</script>") 
End If
